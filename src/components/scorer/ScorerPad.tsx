...
import { Undo2, ArrowLeftRight, AlertOctagon, CheckCircle2, Users } from 'lucide-react';
    ...
    <div className="bg-white rounded-3xl border border-slate-200/90 p-4 sm:p-5 shadow-md no-select">
      ...
      <div className="flex items-center justify-between gap-2 pt-3 border-t border-slate-100">
        ...
        <button
          ...
          className="flex-1 flex items-center justify-center space-x-1.5 py-2.5 rounded-xl bg-slate-100 text-slate-800 hover:bg-slate-200 active:scale-95 border border-slate-200 text-xs font-semibold transition-all cursor-pointer"
        >
        ...
        {onOpenSquads && (
          <button
            ...
            className="flex-1 flex items-center justify-center space-x-1.5 py-2.5 rounded-xl bg-slate-100 text-indigo-700 hover:bg-indigo-50 hover:border-indigo-200 active:scale-95 border border-slate-200 text-xs font-bold transition-all cursor-pointer"
            title="Edit player names or add new players"
          >
        ...
        <button
          ...
          className="flex items-center justify-center space-x-1.5 px-3 py-2.5 rounded-xl bg-slate-100 hover:bg-rose-50 hover:text-rose-700 text-slate-600 border border-slate-200 text-xs font-medium transition-all cursor-pointer"
